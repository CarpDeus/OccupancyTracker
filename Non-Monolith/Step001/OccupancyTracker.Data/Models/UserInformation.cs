...
namespace OccupancyTracker.Data.Models
{
    ...
    public class UserInformation
    {
        ...
        {
            UserSsoInformationIdLastLoggedIn = userSsoInformationIdLastLoggedIn;
            ContactAddress = new Address();
            ContactPhoneNumber = new PhoneNumber();
        }
        ...
        [NotMapped]
        public string CurrentStatusDescription { get { return Statuses.DataStatus.FromId(CurrentStatusId).Name; } }
