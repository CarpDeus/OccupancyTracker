...
namespace OccupancyTracker.Data.Models
{
    ...
    public class Organization
    {
        ...
        [NotMapped]
        public string CurrentStatusDescription { get { return Statuses.DataStatus.FromId(CurrentStatus).Name; } }
        ...
        public bool FilterCriteria(string filter)
        {
            ...
            return Utility.FilterCriteria(OrganizationName, filter) ||
                Utility.FilterCriteria(OrganizationDescription, filter) ||
                OrganizationAddress.FilterCriteria(filter) ||
                PhoneNumber.FilterCriteria(filter);
        }
